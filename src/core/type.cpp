...
BuiltinType::Builtin BuiltinType::getKind() const
{
    return m_builtin;
}
...
std::optional<StructType::Element> StructType::getElement(const std::string& name)
{
...
Type* PointerType::getPointee()
{
    return m_pointee;
}
const Type* PointerType::getPointee() const
{
    return m_pointee;
}
...
bool BuiltinType::isInt() const
{
    return m_builtin == Int;
}

bool BuiltinType::isFloat() const
{
    return m_builtin == Float;
}
...
bool Type::isSame(Type* lhs, Type* rhs)
{
    ...
    {
        if (lhs->getAs<ArrayType>()->getCount() != rhs->getAs<ArrayType>()->getCount())
            return false;
...
{
    return m_builtin == Bool;
}

bool BuiltinType::isChar() const
{
    return m_builtin == Char;
}

bool BuiltinType::isShort() const
{
    return m_builtin == Short;
}

bool BuiltinType::isLong() const
{
    return m_builtin == Long;
}
